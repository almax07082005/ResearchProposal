...
\cite{HarmonizingTaxonomies} analyzed very low number of paipers, which can lead to misinterpritation of results. \cite{AnomalyDetection} offfers researches in many areas of DevOps. \cite{art20} based their analysis only on public repositories. \cite{art21} not sure if DevOps actually was applied in selected cases.
